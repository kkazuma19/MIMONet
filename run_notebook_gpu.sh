...
srun --account=bcnx-delta-gpu --partition=gpuA100x4 --gpus=1 --time=08:00:00 --nodes=1 --ntasks-per-node=1 --mem=128g jupyter-notebook --no-browser --port=$MYPORT --ip=0.0.0.0